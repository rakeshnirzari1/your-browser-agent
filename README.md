...
| `EADDRINUSE` on port 7799 | Another instance is already bound to that port — stop it, or set `YBA_PORT` in both the server's env and the extension popup's relay address |
